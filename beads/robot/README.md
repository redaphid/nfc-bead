...
| `NFC_POS = (0, -1.5)` despite 1/16 perimeter clip | The single missed perimeter point sits at the body-arm gap edge (the gap is part of the silhouette outline, not a fill artifact). Shifting NFC further to either side would clip more. Accepted as cosmetic: the pocket recesses 0.8 mm into the bottom half's inner face; the missing 0.7 mm of arc is at the very rim where the sticker doesn't reach. |
